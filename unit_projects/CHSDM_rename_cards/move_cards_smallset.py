...
# Define paths
csv_file = 'rename_smallset.csv'  # Replace with your actual CSV file name
source_folder = 'chsdm_cards'  # Folder where original files and subfolders are located
destination_folder = 'consolidated'  # Folder to move renamed files
duplicates_folder = 'smallset_duplicates'  # Folder to store duplicates
    ...
    with open(csv_file, newline='') as csvfile:
        ...
        for row in reader:
            ...
            if original_name in filelist:
                ...
                with open("smallset_duperow.txt", "a") as f:
            ...
            if original_path is None:
                ...
                with open("smallset_missing.txt", "a") as f:
                    f.write(f"{original_name}\n")
                continue
            else:
