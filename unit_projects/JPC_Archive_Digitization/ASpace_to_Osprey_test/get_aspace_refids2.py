...
cur.execute("DELETE FROM jpc_aspace_resources1")
logger.info(cur.statement)
cur.execute("DELETE FROM jpc_aspace_data_1")
logger.info(cur.statement)
...
for resource in results['results']: 
    ...
    cur.execute("INSERT INTO jpc_aspace_resources1 "
    ...
    for c01_item in c01_list:
        ...
        for c02_item in c02_items:
            ...
            for c03_item in c03_items:
                ...
                table_id = str(uuid.uuid4())
                i += 1
                cur.execute("INSERT INTO jpc_aspace_data_1 "
